<?php
	...
	$wp_cat_id=$_REQUEST['wp_cat_id'];
	if(isset($_POST['submit']) and $_POST['submit']!='')
	{
		$wp_cat_name=mysql_real_escape_string($_POST['wp_cat_name']);
		$status=$_POST['status'];
		
		$ob2->update_wpcat($wp_cat_id,$wp_cat_name,$status);
		echo "<script>window.location='wplanner_cat.php'</script>";
	}
	
	$resultwp=$ob2->get_wpcat_by_cat($wp_cat_id);
	...
	<div id="main">
        ...
        <tr>
        	...
        	<tr>
               ...
               <span class="red_text">Edit Wedding Planner Service </span>
                </td>
            </tr>
            <tr>
				...
				<br />       
                    ...
                    <table style="border:solid 5px #7e0000;" width="500px">
                        ...
                        <td class="errormsg"><input name="wp_cat_name" type="text" id="wp_cat_name" value="<?php echo $row['wp_cat_name']; ?>" style="width:150px;" />&nbsp;</td>
                       </tr>
                       <tr>
