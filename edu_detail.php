...
$edu=new edu_detail();
		...
		if(isset($_REQUEST['act']) and $_REQUEST['act']!='')
		{
			...
			$edu->change_status($value,1);
		}
		
		if(isset($_REQUEST['dact']) and $_REQUEST['dact']!='')
		{
			$value=intval($_REQUEST['dact']);
			$edu->change_status($value,0);
		}
		
		if(isset($_REQUEST['edu_id']) and $_REQUEST['action']=='del')
		{
			$value=intval($_REQUEST['edu_id']);
			$edu->del_edu($value);
		}
		...
		$condition="";
		if(isset($_REQUEST['search']) and $_REQUEST['search']!='Search By Education')
		{
			$keyword=$_REQUEST['keywords'];
			$condition=" where edu_name like '%$keyword%' ";
		}		
		
	$result=$edu->get_edu_details($condition);
...
<script type="text/javascript">
	...
	function validatesearch()
	{
		...
		if(kword.value=='Search By Education')
		{
	...
	<div id="main">
        ...
        <table width="1000px" align="center">
        	<tr>
                ...
                <table width="100%">
                    <tr>  
					<td align="left" style="border:none;width:50%;" class="red_text">Education Details</td>        
				  ...
				  {
				  ?>
                  <a href="add_edu_detail.php"><img src="images/btn_add.gif" height="36" width="116" border="0" /></a>                 <?php } ?>
...
<input type="text" name="keywords" id="keywords" title="Search By Education" style="width:250px;color:#999999;" value="<?php if(isset($_REQUEST['keywords']) and $_REQUEST['keywords']!=''){ echo $_REQUEST['keywords']; }else{ echo "Search By Education"; } ?>" onblur="if (this.value == '') {this.value = 'Search By Education';}" onfocus="if (this.value == 'Search By Education') {this.value = ''}" autocomplete="off" />
</td>
<td style="border:none;">
<input type="image" src="images/btn_search.gif" name="search" value="search" /><input type="hidden" name="search" value="search" />
</td>
<td style="border:none;">
<img src="images/btn_showal.gif" onclick="window.location='edu_detail.php'" />
</td></tr></table>
                    ...
                    <table style="border:solid 5px #7e0000;" width="990px" align="center">
                        <tr bgcolor="#CCCCCC" style="color:#7e0000;">
                            ...
                            <td height="40px" width="400px">
                                <span class="con_title">Education Name</span>                            </td>
                            <td width="300px">
					   ...
					   <?php					   
                         ...
                         ?>
                        <tr>
                            <td align="center" width="20px"><input type="checkbox" id="ch1[]" name="ch1[]" value="<?php echo $row['edu_id']; ?>" /></td>
                            <td class="text"><?php echo $row['edu_name']; ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <?php
											if(isset($_REQUEST['page']) && $_REQUEST['page']!='')
												...
												if($_SESSION['profile_status']=='Yes')
											  {
												...
												{													
										?>
                                         <a href="edu_detail.php?<?php if(isset($param_1))echo $param_1; ?>dact=<?php echo $row['edu_id']; ?>"><img src="images/btn_deact.gif" height="35" width="35" title="Inactive" border="0"/></a>
                                               <?php
												}
												else
												{
											?>
                                            <a href="edu_detail.php?<?php if(isset($param_1))echo $param_1; ?>act=<?php echo $row['edu_id']; ?>"><img src="images/btn_act.gif" height="35" width="35" title="Active" border="0"/></a>
                                             <?php
												}
											}
											?>                                        </td>
                                        <td style="border:none;">
										  <?php 
											  ...
											  {
											  ?>
										<a href="edit_edu_detail.php?<?php if(isset($param_1))echo $param_1; ?>edu_id=<?php echo $row['edu_id']; ?>"><img src="images/btn_edit.gif" height="35" width="35" title="EDIT" border="0"/></a>
										<?php
												}
											?></td>
                                        <td style="border:none;">
										 <?php 
											  ...
											  {
											  ?>
                                             <a href="javascript:if(confirm('Are you sure, you want to delete this Record?')) {location.href='edu_detail.php?edu_id=<?php echo $row['edu_id']?>&amp;action=del'};"><img src="images/btn_delete.gif" height="35" width="35" title="DELETE" border="0"/></a>
											 <?php
												}
											?>                                        </td>
                                        <td style="border:none;display:none;">
                                             <a href="edu_detail.php?act=<?php echo $row['edu_id']; ?>"><img src="images/btn_preview.gif" height="35" width="35" title="Preview" border="0"/></a>                                        </td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
