<?php
	...
	if(isset($_POST['submit']) and $_POST['submit']!='')
	{
		...
		$ob->update_wp($wp_id,$wp_cat_id,$wp_name,$wp_desc,$wp_contact,$wp_mobile,$wp_email,$wp_rate_from,$wp_rate_to,$status);	
		echo "<script>window.location='wplanner.php'</script>";
	}
	
	$resultwp=$ob->get_wp_by_id($wp_id);
	$row=mysql_fetch_array($resultwp);
?>
	...
	<div id="main">
        ...
        <tr>
        	...
        	<tr>
               ...
               <span class="red_text">Edit Wedding Planner Details</span>
                </td>
            </tr>
            <tr>
				...
				<br />       
                    ...
                    <table style="border:solid 5px #7e0000;" width="561">
                        ...
                        <td width="395" class="errormsg"> <select name="wp_cat_name" id="wp_cat_name" style="width:150px;">
							...
							?>
							<option value="<?php echo $row2['wp_cat_id']; ?>" <?php if($row['wp_cat_id']==$row2['wp_cat_id']){ ?>selected="selected" <?php } ?>><?php echo $row2['wp_cat_name']; ?></option>
							<?php
								}
							?>
					      </select>&nbsp;</td>
                        ...
                        <td width="395" class="errormsg"><input name="wp_name" type="text" id="wp_name" value="<?php echo $row['wp_name']; ?>" style="width:150px;" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="168"><font id="star">*</font>&nbsp;<span style="font-size:13px; padding-left:5px;">Description:</span></td>
	                    <td class="errormsg"><textarea name="wp_desc" id="wp_desc" style="width:150px;"><?php echo $row['wp_desc']; ?></textarea>&nbsp;			
						</td>
                       </tr>
					   <tr>
                        <td height="40" width="168"><font id="star">*</font>&nbsp;<span style="font-size:13px; padding-left:5px;">Phone Number:</span></td>
                        <td class="errormsg"><input name="phone" type="text" id="phone" value="<?php echo $row['wp_contact']; ?>" style="width:150px;" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="168"><font id="star">*</font>&nbsp;<span style="font-size:13px; padding-left:5px;">Mobile Number:</span></td>
                        <td class="errormsg"><input name="mobile" type="text" id="mobile" value="<?php echo $row['wp_mobile']; ?>" style="width:150px;" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="168"><font id="star">*</font>&nbsp;<span style="font-size:13px; padding-left:5px;">Email Id:</span></td>
                        <td class="errormsg"><input name="email" type="text" id="email" value="<?php echo $row['wp_email']; ?>" style="width:150px;" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="168"><font id="star">*</font>&nbsp;<span style="font-size:13px; padding-left:5px;">Rate From:</span></td>
                        <td class="errormsg"><input name="ratefrom" type="text" id="ratefrom" value="<?php echo $row['wp_rate_from']; ?>" style="width:150px;" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="168"><font id="star">*</font>&nbsp;<span style="font-size:13px; padding-left:5px;">Rate To:</span></td>
                        <td class="errormsg"><input name="rateto" type="text" id="rateto" value="<?php echo $row['wp_rate_to']; ?>" style="width:150px;" />&nbsp;</td>
                       </tr>
                       <tr>
