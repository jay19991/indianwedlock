...
?>
	...
	?>
                        ...
                        <tr>
                          ...
                          <td style="padding-left:10px;"><input name="password" type="password" class="forminput1" id="password" value="voice" readonly="readonly" />                          </td>
                        </tr>
                        <tr>
                          ...
                          <td style="padding-left:10px;"><input name="cpassword" type="password" class="forminput1" id="cpassword" value="voice" readonly="readonly" />                          </td>
                        </tr>
