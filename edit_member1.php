...
include("secure.php");
	...
	if(isset($_POST['submit']) and $_POST['submit']!='')
	{
		...
		$family_details=$_POST['familt_details'];	  
		...
		$father_living_status=$_POST['father_living_status'];	  
		$father_name=$_POST['father_name'];	  
		$father_occupation=$_POST['father_occupation'];	  
		$mother_living_status=$_POST['mother_living_status'];
		...
		$part_expect=$_POST['part_expect'];//remina	  
		...
		echo $sql="update register set firstname='$fname',lastname='$lname',gender='$gender',birthdate='$birthdate',m_status='$m_status',tot_children='$tot_children',status_children='$status_children',m_tongue='$m_tongue',religion='$religion',caste='$caste',subcaste='$subcaste',profileby='$profilby',reference='$reference',email='$email',password='$password',gothra='$gothra',star='$star',moonsign='$moonsign',horoscope='$horoscope',manglik='$manglik',birthplace='$birthplace',birthtime='$birthtime',terms='$terms',education='$education',edu_detail='$edu_detail',income='$income',occupation='$occupation',emp_in='$emp_in',weight='$weight',height='$height',b_group='$b_group',complexion='$complexion',bodytype='$bodytype',diet='$diet',smoke='$smoke',drink='$drink',address='$address',country_id='$country_id',state_id='$state_id',city='$city_id',locality='$locality',phone='$phone',mobile='$mobile',residence='$residence',profile_text='$profile_text',family_details='$family_details',family_value='$family_value',family_type='$family_type',family_status='$family_status',family_origin='$family_origin',no_of_brothers='$no_of_brother',no_of_sisters='$no_of_sister',no_marri_sister='$no_marri_sister',father_living_status='$father_living_status',father_name='$father_name',father_occupation='$father_occupation',no_of_sisters='$no_of_sister',mother_living_status='$mother_living_status',mother_name='$mother_name',mother_occupation='$mother_occupation',looking_for='$looking_status',part_frm_age='$part_frm_age',part_to_age='$part_to_age',part_edu='$part_edu',part_expect='$part_expect',part_country_living='$part_country_living',part_height='$part_height',part_complexation='$part_complexation',part_religion='$part_religion',part_resi_status='$part_resi_status',hobby='$hobby',interest='$interest'"; exit;
...
<script language="javascript" src="js/timepicker.js"></script>
<script language="javascript" src="../js/register_pagevalid.js"></script>
<script language="javascript" src="../js/register_page_2valid.js"></script>
<script language="javascript" src="../js/register_page_3valid.js"></script>
	...
	<div id="main">
        ...
        <tr>
            ...
            <tr>
				...
				<br />       
					<form action="" method="post" name="MatriForm"  onsubmit="return Valid()" >
                       ...
                       <tr >
                        ...
                        <tr>
                        	...
                        	<td width="726" style="padding-left:10px;">
                           	<input name="fname" type="text" class="forminput" id="fname" value="<?php echo $row['firstname']; ?>"  />&nbsp;                            </td>
                        </tr>
                        <tr>
                        	<td height="40" width="250">
                            	<font id="star" style="padding-left:10px;">*</font>&nbsp;
	...
	?>
					  ...
					  <tr>
                        	...
                        	<td style="padding-left:10px; font-size:12px;" class="text">
                            	<input name="m_status" type="radio"  value="Unmarried" onClick="return HaveChildnp(this)" <?php if($row['m_status']=="Unmarried"){  ?> checked="checked" <?php } ?> />
                            	Unmarried&nbsp;&nbsp;&nbsp;
                            	<input name="m_status" type="radio"  value="Widow/Widower" onClick="return HaveChildnp(this)" <?php if($row['m_status']=="Widow/Widower"){  ?> checked="checked" <?php } ?> />
                            	Widow/Widower &nbsp;
                            	<input name="m_status" type="radio"  value="Divorcee" onClick="return HaveChildnp(this)" <?php if($row['m_status']=="Divorcee"){  ?> checked="checked" <?php } ?> />
                            	Divorcee&nbsp;&nbsp;&nbsp;
                            	<input name="m_status" type="radio"  value="Separated" onClick="return HaveChildnp(this)" <?php if($row['m_status']=="Separated"){  ?> checked="checked" <?php } ?> />
                            	Separated                            </td>
                      </tr> 
                        ...
                        <tr>
                        	...
                        	<td style="padding-left:10px;">
                            	<select name="tot_children" id="tot_children" size="1" class="forminput" onChange="return HaveChildnp(this)">
                        ...
                        <tr>
                        	...
                        	<td style="font-size:13px; padding-left:10px;"  class="text" >
                            	<input  name="status_children" id="status_children" type="radio"  value="Yes" <?php if($row['status_children']=="Yes"){  ?> checked="checked" <?php } ?> />
                            	Living with me&nbsp;
                            	<input name="status_children" type="radio" id="status_children" onFocus="if(disabled)blur();" value="No"<?php if($row['status_children']=="No"){  ?> checked="checked" <?php } ?> />
                        ...
                        <?php
								while($rowm=mysql_fetch_array($mtres))
								{
							?>
								<option value="<?php echo $rowm['mtongue_id']; ?>" <?php if($rowm['m_tongue']==$row['mtongue_id']){ ?> selected="selected" <?php } ?>><?php echo $rowm['mtongue_name']; ?></option>
							<?php		
								}
							?>
                          </select>                            </td>
                        ...
                        <tr>
                            ...
                            <?php
								...
								{
							?>
                             <option value="<?php echo $row22['religion_id']; ?>" <?php if($row22['religion_id']==$row['religion_id']){ ?> selected="selected" <?php } ?>><?php echo $row22['religion_name']; ?></option>
							<?php		
								}
							?>
						  </select>						   </td>
                        ...
                        <tr>
                        	...
                        	<td id="castediv" style="padding-left:10px;">
							 ...
							 <?php
								while($row23=mysql_fetch_array($rel4))
								{
							?>
                             <option value="<?php echo $row23['caste_id']; ?>" <?php if($row23['caste']==$row['caste_id']){ ?> selected="selected" <?php } ?>><?php echo $row23['caste_name']; ?></option>
							<?php		
								}
							?>
						</select>                            </td>
                        ...
                        <tr>
                        	<td height="40" width="250">
                                ...
                                <span style="font-size:13px; padding-left:5px;">
                                	Email ID:                                </span>                            </td>
                        	<td style="padding-left:10px;">
                            	<input name="email" type="text" class="forminput" id="email"  value="<?php echo $row['email']; ?>" >                            </td>
                        </tr>
                        <tr>
                        	<td height="40" width="250">
                            	<font id="star" style="padding-left:10px;">*</font>&nbsp;
                                <span style="font-size:13px; padding-left:5px;">
                                	Password:                                </span>                            </td>
                        	<td style="padding-left:10px;">
                            	<input name="password" type="password" class="forminput" id="password" >                            </td>
                        </tr>
                        <tr>
                        	<td height="40" width="250">
                            	<font id="star" style="padding-left:10px;">*</font>&nbsp;
...
<td colspan="2" height="30px" bgcolor="#CCCCCC">
						...
						<td height="40" width="160px"><font id="star" style="padding-left:10px;">*</font>&nbsp; <span style="font-size:13px; padding-left:5px;"> Education Details: </span> </td>
                          <td style="padding-left:10px;"><select name="edu_detail" id="edu_detail" class="forminput">
							...
							<?php
								...
								{
							?>
                             <option value="<?php echo $e1['edu_id']; ?>" <?php if($e1['edu_detail']==$row['edu_id']){ ?> selected="selected" <?php } ?>><?php echo $e1['edu_name']; ?></option>
							<?php		
								}
							?>
                          ...
                          <td style="padding-left:10px;"><select name="occupation" id="occupation" class="forminput">
                              <option value="">Select </option>
							   ...
							   <?php
								...
								{
							?>
                             <option value="<?php echo $occ['occ_id']; ?>" <?php if($occ['occupation']==$row['occ_id']){ ?> selected="selected" <?php } ?>><?php echo $occ['ocp_name']; ?></option>
							<?php		
								}
							?>
                        ...
                        <tr>
                          ...
                          <td style="padding-left:10px;"><select name="country_id" class="forminput" id="country_id" onchange="getState('select_state.php?country_id='+this.value)">
							...
							<tr>
							  ...
							  <td style="padding-left:10px;" id="statediv"><select name="state" class="forminput" id="state" onchange="getCity('select_city.php?state_id='+this.value)">
							...
							<tr>
							  ...
							  <td style="padding-left:10px;" id="citydiv">
							  <select name="city_id" class="forminput" id="city_id" onchange="getLoc('select_locality.php?city_id='+this.value)">
							...
							<tr>
							  <td height="40" width="160px"><font id="star" style="padding-left:10px;">*</font>&nbsp; <span style="font-size:13px; padding-left:5px;"> Locality: </span> </td>
							  <td style="padding-left:10px;" id="locdiv"><select name="locality" id="locality" class="forminput">
								  <option value="">Choose Locality</option>
								  <?php
												
									while($row7=mysql_fetch_array($coun4))
									{
								?>
								 <option value="<?php echo $row7['loc_id']; ?>" <?php if($row7['locality']==$row['loc_id']){ ?> selected="selected" <?php } ?>><?php echo $row7['loc_name']; ?></option>
								<?php		
									}
								?>		
							...
							<tr>
							  ...
							  <td style="padding-left:10px;"><input name="txtCC" type="text" class="medforminput" id="txtCC" style="width:40px;" onfocus="if (this.value == '91') this.value = '';" onkeyup="check_phone('txtCC')" value="+91" size="10" maxlength="10" />
								...
								-
								<input name="phone" type="text" value="<?php echo $row['phone']; ?>" class="medforminput" id="phone" size="10" maxlength="10" style="width:120px;" onkeyup="check_phone('txtPhone')" />                          </td>
							</tr>
							<tr>
							...
							<tr>
							  ...
							  <td style="font-size:13px; padding-left:10px;"  class="text"><input name="looking_for" type="radio"  value="Unmarried" id="looking_for" <?php if($row['looking_for']=="Unmarried"){  ?> checked="checked" <?php } ?> />
								...
								Widow/Widower &nbsp;&nbsp;&nbsp;
								<input name="looking_for" type="radio"  value="Divorce" id="looking_for" <?php if($row['looking_for']=="Divorcee"){  ?> checked="checked" <?php } ?> />
								Divorcee&nbsp;&nbsp;&nbsp;
							...
							<tr>
							  ...
							  <td style="padding-left:10px;"><select name="city" class="forminput" id="city">
					...
					?>
							...
							<tr>
							  ...
							  <td style="padding-left:10px;"><select name="religion" id="religion" class="forminput" onchange="getCaste('../select_caste.php?religion_id='+this.value)">
								  <option value="">Select Religion</option>
								  <?php
									while($row23=mysql_fetch_array($rel4))
									{
								?>
								  <option value="<?php echo $row23['religion_id']; ?>"><?php echo $row23['religion_name']; ?></option>
								  <?php
									}
								?>
								</select>                          </td>
							...
							<tr>
							  ...
							  <td style="padding-left:10px;"><select name="caste" id="caste" class="forminput" >
								  <option value="">Choose Caste</option>
								  <?php
									while($row24=mysql_fetch_array($rel5))
									{
								?>
								  <option value="<?php echo $row24['caste_id']; ?>"><?php echo $row24['caste_name']; ?></option>
								  <?php
									}
								?>
								</select>                          </td>
							...
							<tr>	
								...
								<td>
									...
									<a href="cms.php?cms_id=12" target="_blank" style="text-decoration:none;font-weight:bold;" class="green_text">I Accept the terms and Conditions </a>                            </td>
							</tr>
							<tr>
							<td height="40">&nbsp;</td>
							<td style="padding-left:10px;"><input type="image" name="submit" src="images/btn_submit.gif" value="submit" /><input type="hidden" name="submit" value="submit" /><img src="images/btn_cancel.gif" onclick="window.location='.php'" /></td>
						   </tr>
						</table>
				  </form>
					</td>
