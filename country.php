...
$cn=new country();
		...
		if(isset($_REQUEST['country_id']) and $_REQUEST['action']=='del')
		{
			$value=intval($_REQUEST['country_id']);
		...
		$condition="";
		if(isset($_REQUEST['search']) and $_REQUEST['search']!='Search By Country')
		{
			$keyword=$_REQUEST['keywords'];
			$condition=" where country_name like '%$keyword%' ";
		}		
		
	$result=$cn->get_countries($condition);
...
<script type="text/javascript">
	...
	function validatesearch()
	{
		...
		if(kword.value=='Search By Country')
		{
	...
	<div id="main">
        ...
        <table width="1000px" align="center">
        	<tr>
                ...
                <table width="100%">
                    <tr>  
					<td align="left" style="border:none;width:50%;" class="red_text">Country Details</td>        
				  ...
				  {
				  ?>
                  <a href="add_country.php"><img src="images/btn_add.gif" height="36" width="116" border="0" /></a>                  <?php } ?>
...
<input type="text" name="keywords" id="keywords" title="Search By Country" style="width:250px;color:#999999;" value="<?php if(isset($_REQUEST['keywords']) and $_REQUEST['keywords']!=''){ echo $_REQUEST['keywords']; }else{ echo "Search By Country"; } ?>" onblur="if (this.value == '') {this.value = 'Search By Country';}" onfocus="if (this.value == 'Search By Country') {this.value = ''}" autocomplete="off" />
</td>
<td style="border:none;">
<input type="image" src="images/btn_search.gif" name="search" value="search" /><input type="hidden" name="search" value="search" />
</td>
<td style="border:none;">
<img src="images/btn_showal.gif" onclick="window.location='country.php'" />
</td></tr></table>
                    ...
                    <table style="border:solid 5px #7e0000;" width="990px" align="center">
                        <tr bgcolor="#CCCCCC" style="color:#7e0000;">
                            ...
                            <td height="40px" width="400px">
                                <span class="con_title">Country Name</span>
                            </td>
                            <td width="300px">
					   ...
					   <?php					   
                         ...
                         ?>
                        <tr>
                            <td align="center" width="20px"><input type="checkbox" id="ch1[]" name="ch1[]" value="<?php echo $row['country_id']; ?>" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <?php
											if(isset($_REQUEST['page']) && $_REQUEST['page']!='')
												...
												if($_SESSION['profile_status']=='Yes')
											  {
												...
												{													
										?>
                                         <a href="country.php?<?php if(isset($param_1))echo $param_1; ?>dact=<?php echo $row['country_id']; ?>"><img src="images/btn_deact.gif" height="35" width="35" title="Inactive" border="0"/></a>
                                               <?php
												}
												else
												{
											?>
                                            <a href="country.php?<?php if(isset($param_1))echo $param_1; ?>act=<?php echo $row['country_id']; ?>"><img src="images/btn_act.gif" height="35" width="35" title="Active" border="0"/></a>
                                             <?php
												}
											}
											?>                                        </td>
                                        <td style="border:none;">
										  <?php 
											  ...
											  {
											  ?>
										<a href="edit_country.php?<?php if(isset($param_1))echo $param_1; ?>country_id=<?php echo $row['country_id']; ?>"><img src="images/btn_edit.gif" height="35" width="35" title="EDIT" border="0"/></a>
										<?php
												}
											?></td>
                                        <td style="border:none;">
										 <?php 
											  ...
											  {
											  ?>
                                             <a href="javascript:if(confirm('Are you sure, you want to delete this Record?')) {location.href='country.php?country_id=<?php echo $row['country_id']?>&amp;action=del'};"><img src="images/btn_delete.gif" height="35" width="35" title="DELETE" border="0"/></a>
											 <?php
												}
											?>                                        </td>
                                        <td style="border:none;display:none;">
                                             <a href="country.php?act=<?php echo $row['country_id']; ?>"><img src="images/btn_preview.gif" height="35" width="35" title="Preview" border="0"/></a>                                        </td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
