...
$condition="";
		if(isset($_REQUEST['search']) and $_REQUEST['search']!='Search By Gender')
		{
			...
			$condition .= " AND gender like '%$keyword%'";
		}	

 $rr="SELECT * FROM register where status = 'Active' && order_status='No'".$condition;
...
<script type="text/javascript">
	...
	function validatesearch()
	{
		...
		if(kword.value=='Search By Gender')
		{
	...
	<div id="main">
        ...
        <table width="1000px" align="center">
        	<tr>
                ...
                <table width="100%">
                    <tr>  
					<td align="left" style="border:none;width:50%;" class="red_text">Approve Active To Paid Member Details</td>        
		...
		<form name="form1" method="post" action=""> 
            <tr>
                ...
                <tr>
                  ...
                  <td width="166" bgcolor="#999966" ><a href="#" onClick="newWindow('approve_paid_form.php?id=<?php  echo $row['matri_id']?>','','520','550')"
				  style="color:#FFFFFF; font-size:14px;text-decoration:none; font-weight:bold;" >Approve As Paid</a></td>
                </tr>
                <?php
								$i++;
								$count++;
