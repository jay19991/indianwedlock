<?php
	...
	if(isset($_POST['submit']) and $_POST['submit']!='')
	{
		...
		$ob=new payments();
		$ob->add_payment($pmatri_id,$pfirstname,$plastname,$pemail,$paddress,$paymode,$pactive_dt,$p_plan,$plan_duration,$p_no_contacts,$p_amount,$p_bank_detail);	
	...
	<div id="main">
        ...
        <tr>
        	...
        	<tr>
               ...
               <span class="red_text">Add Payment Details </span>
                </td>
            </tr>
            <tr>
				...
				<br />       
                    ...
                    <table style="border:solid 5px #7e0000;" width="580">
                        ...
                        <td width="379" class="errormsg"><input name="pmatri_id" type="text" id="pmatri_id" value="" style="width:150px;" />&nbsp;</td>
                       </tr>                    
                       <tr>
                        <td height="40" width="181"><font id="star">*</font>&nbsp;<span style="font-size:15px; padding-left:5px;">First Name:</span></td>
                        <td class="errormsg"><input name="pfirstname" type="text" id="pfirstname" value="" style="width:150px;" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="181"><font id="star">*</font>&nbsp;<span style="font-size:15px; padding-left:5px;">Last Name:</span></td>
                        <td class="errormsg"><input name="plastname" type="text" id="plastname" value="" style="width:150px;" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="181"><font id="star">*</font>&nbsp;<span style="font-size:15px; padding-left:5px;">Email:</span></td>
                        <td class="errormsg"><input name="pemail" type="text" id="pemail" value="" style="width:150px;" />&nbsp;</td>
                       </tr>
						<tr>
                        <td height="40" width="181"><font id="star">*</font>&nbsp;<span style="font-size:15px; padding-left:5px;">Address:</span></td>
                        <td class="errormsg"><textarea name="paddress" id="paddress" style="width:150px;"></textarea>&nbsp;</td>
                       </tr>
					   <tr>
					   ...
					   <tr>
                        ...
                        <td class="errormsg"><input name="pactive_dt" type="text" id="pactive_dt" value="" style="width:150px;" readonly="true" /><script language="JavaScript">
	new tcal ({
		// form name
		...
		'controlname': 'pactive_dt'
					   ...
					   <tr>
						...
						<?php
							...
							{
						?>
							<option value="<?php echo $memrow['plan_id']; ?>"><?php echo $memrow['plan_name']; ?></option>
						<?php
							}
						?>
						</select>&nbsp;</td>
					   ...
					   <tr>
                        ...
                        <td class="errormsg"><input name="plan_duration" type="text" id="plan_duration" value="" style="width:150px;" readonly="true" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="181"><font id="star">*</font>&nbsp;<span style="font-size:15px; padding-left:5px;">	No of Contacts:</span></td>
                        <td class="errormsg"><input name="p_no_contacts" type="text" id="p_no_contacts" value="" style="width:150px;" readonly="true" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="181"><font id="star">*</font>&nbsp;<span style="font-size:15px; padding-left:5px;">	Payable Amount:</span></td>
                        <td class="errormsg"><input name="p_amount" type="text" id="p_amount" value="" style="width:150px;" readonly="true" />&nbsp;</td>
                       </tr>
					   <tr>
                        <td height="40" width="181"><font id="star">*</font>&nbsp;<span style="font-size:15px; padding-left:5px;">	Bank Details:</span></td>
                        <td class="errormsg"><textarea name="p_bank_detail" id="p_bank_detail" style="width:150px;"></textarea>&nbsp;</td>
                       </tr>
                       <tr>
                        <td height="40">&nbsp;</td>
