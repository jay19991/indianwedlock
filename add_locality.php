	...
	<div id="main">
        ...
        <tr>
        	...
        	<tr>
               ...
               <span class="red_text">Add Locality Details</span>
                </td>
            </tr>
            <tr>
				...
				<br />       
					...
					<tr>
                        ...
                        <td class="errormsg"><input name="locality" type="text" id="locality" value="" style="width:150px;"/>
                        &nbsp;</td>
                       </tr>					   					   
                       <tr>
...
if(isset($_POST['submit']) and $_POST['submit']!='')
	{	
		...
		$city_id=$_POST['city'];
		$loc_name=mysql_real_escape_string(ucwords($_POST['locality']));		
		$status=$_POST['status'];
		
		$ob=new locality();
		$ob->add_locality($city_id,$loc_name,$status);
		echo "<script>alert('You Are Successfully Enter Records');window.location='locality.php'</script>";
