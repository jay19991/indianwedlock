<?php
include("../BusinessLogic/class.chat.php");
...
$role=new chat();
		...
		$condition="";
		if(isset($_REQUEST['search']) and $_REQUEST['search']!='Search By From,To')
		{
			$keyword=$_REQUEST['keywords'];
			$condition=" where ((from like '%$keyword%') or (to like '%$keyword%'))";
		}		
		
	$result=$role->get_chat($condition);
...
<script type="text/javascript">
	...
	function validatesearch()
	{
		...
		if(kword.value=='Search By From,To')
		{
	...
	<div id="main">
        ...
        <table width="1000px" align="center">
        	<tr>
                ...
                <table width="100%">
                    <tr>  
					<td align="left" style="border:none;width:50%;" class="red_text">Customer Chat Details</td>        
...
<input type="text" name="keywords" id="keywords" title="Search By From,To" style="width:250px;color:#999999;" value="<?php if(isset($_REQUEST['keywords']) and $_REQUEST['keywords']!=''){ echo $_REQUEST['keywords']; }else{ echo "Search By From,To"; } ?>" onblur="if (this.value == '') {this.value = 'Search By From,To';}" onfocus="if (this.value == 'Search By From,To') {this.value = ''}" autocomplete="off" />
</td>
<td style="border:none;">
<input type="image" src="images/btn_search.gif" name="search" value="search" /><input type="hidden" name="search" value="search" />
</td>
<td style="border:none;">
<img src="images/btn_showal.gif" onclick="window.location='chat.php'" />
</td></tr></table>
                    ...
                    <table style="border:solid 5px #7e0000;" width="990px" align="center">
                        <tr bgcolor="#CCCCCC" style="color:#7e0000;">
                            ...
                            <td height="44" width="95">
                                <span class="con_title">From</span>                            </td>
							<td height="44" width="130">
                                <span class="con_title">To</span>                            </td>
					   ...
					   <?php					   
                        ...
                        <tr style="font-size:13px;">
                          <td align="center" width="41"><input type="checkbox" id="ch1[]" name="ch1[]" value="<?php echo $row['id']; ?>" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;" align="left">
                                         <?php 
											  ...
											  {
											  ?>
                                             <a href="javascript:if(confirm('Are you sure, you want to delete this Record?')) {location.href='chat.php?id=<?php echo $row['id']?>&amp;action=del'};"><img src="images/btn_delete.gif" height="35" width="35" title="DELETE" border="0"/></a><?php } ?>
                                        </td>
