<?php
	...
	{ 
	 ...
	 if($_FILES['file']['name']!='')
	  ...
	  $up="update payment_method set check_desc='$c',pay_img='$pi',status='$s' where pay_id='3'";
	  $up2=mysql_query($up);
	  echo "<script>window.location='payment_option.php'</script>";
	  
	}
		
	$sqlpp="select * from payment_method where pay_id='3'";
...
function Validate(frm2)
{
 ...
 var image = /(.*?)\.(jpg|JPG|jpeg|png|PNG|gif|GIF|bmp|BMP)$/;
			  ...
			  {
			  alert("Only .gif, .png , .jpeg, .jpg, .bmp file allowed in checkout image!!");
	...
	<div id="main">
        ...
        <tr>
        	...
        	<tr>
               ...
               <span class="red_text">Edit Checkout Details</span>
                </td>
            </tr>
			  <tr>
            <td style="border:none;">&nbsp;</td>
            ...
            <form name="frm2" method="post" action="" onsubmit="return Validate(frm2);" enctype="multipart/form-data">
          	 <table classs="text">
               <tr>
				<td style="border:none;" width="248" class="text" valign="top"><font id="star">*</font>&nbsp;<span style="font-size:13px; padding-left:5px;">Checkout Description:</span></td>
                <td  style="border:none;" width="340" class="errormsg"><textarea name="check_desc"   value="<?php echo $row['check_desc']; ?>" style="width:300px; height:80px;"/><?php  echo $row['check_desc']; ?></textarea>
				</td>
                </tr>
				...
				<tr>
						<td  width="248" style="border:none;" valign="top"><font id="star">*</font>&nbsp;<span style="font-size:13px; padding-left:5px;">Checkout Image (200 * 150):</span></td>
                        <td  width="340" class="errormsg" style="border:none;"><input name="file" type="file" id="file" size="12" />&nbsp;<input type="hidden" name="pay_img" value="<?php echo $row['pay_img']; ?>" />
						<br />
               ...
               <tr>
				<td style="border:none;" width="248" class="text"><font id="star">*</font>&nbsp;<span style="font-size:13px;padding-left:5px;">Status</td>
