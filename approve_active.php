...
$result = mysql_query("SELECT * FROM register where status = 'Inactive'"); 
...
{ 
    ...
    { 
        ...
        if(con) 
        { 
            document.forms[0].action="approve_sms.php?recsno="+checkboxes 
	...
	<div id="main">
        ...
        <table width="1000px" align="center">
        	<tr>
                ...
                <table width="100%">
                    <tr>  
					<td align="left" style="border:none;width:50%;" class="red_text">Approve Inactive to Active Member</td>        
 ...
 ?>
		<form name="form1" method="post" action=""> 
            ...
            <tr>
                ...
                <table width="1000px" align="center">
                    <tr>
					<td width="50" bgcolor="#999966" ><a href="javascript:goSend()" style="color:#FFFFFF; font-size:14px;text-decoration:none; font-weight:bold;">Approve Active</a></td>
