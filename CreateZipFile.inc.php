...
class CreateZipFile {
	...
	public function forceDownload($archiveName) {
		...
		// Security checks
		if( $archiveName == "" ) {
			echo "<html><title>Public Photo Directory - Download </title><body><center><BR><B>ERROR:</B> The download file was NOT SPECIFIED. </center>
</body>
</html>";
			exit;
		}
		elseif ( ! file_exists( $archiveName ) ) {
			echo "<html><title>Public Photo Directory - Download </title><body><center><BR><B>ERROR:</B> File not found. </center>
</body>
</html>";
			exit;
		}
